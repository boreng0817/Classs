...
def render():
    global gCamAng, gCamHeight, gColor, gLight
    ...
    if gColor != 'N':
        glMaterialfv(GL_FRONT, GL_AMBIENT, specularObjectColor)
        glMaterialfv(GL_FRONT, GL_DIFFUSE, specularObjectColor)
    if gLight != 'N':
...
def key_callback(window, key, scancode, action, mods):
    global gCamAng, gCamHeight, gLight, gColor
